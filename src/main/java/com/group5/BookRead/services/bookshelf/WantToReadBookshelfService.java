...
public final class WantToReadBookshelfService implements BookshelfService {
    private BookshelfRepository bookshelfRepository;

    @Autowired
    public WantToReadBookshelfService(final BookshelfRepository bookshelfRepository) {
